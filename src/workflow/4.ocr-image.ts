					...
					jsonSchema: {
						...
						schema: {
							...
							properties: {
								organizer: {
									type: "string",
									description: "Main organizer of the competition",
								},
								institutions: {
									type: "array",
									items: { type: "string" },
								...
								pricing: {
									...
									items: { type: "number" },
									description:
										"Registration fees in IDR. Empty if free. Single value if one price.",
								},
								contact: {
									type: "array",
									items: { type: "string" },
								...
								prize: {
									type: "string",
									description: "Total prize pool in IDR (text)",
								},
								guideUrl: {
									type: "string",
									description: "URL to the guidebook",
								},
								registrationUrl: {
									type: "string",
								...
								location: {
									type: "string",
									description: "Location if offline/hybrid",
								},
								socialMedia: {
									type: "object",
									properties: {
